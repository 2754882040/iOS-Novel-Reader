...
struct LanguagePage: View {
    ...
    var languages = [localizedString(text: strEnglish),
                     localizedString(text: strChinese), localizedString(text: strFrench)]
    ...
    var body: some View {
        Picker(languageSetting, selection: $selectedLanguage) {
            ...
            .onChange(of: selectedLanguage, perform: { selectedLanguage in
