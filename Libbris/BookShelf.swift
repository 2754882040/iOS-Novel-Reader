        ...
        NavigationView{
                VStack{
                    ...
                    BookList(url:"http://libbris2021.us-west-2.elasticbeanstalk.com/ws/book/category/11?start=1&size=5", cId: 11)
                        ...
                        .navigationBarItems(leading: Text(libraryText)
                        .foregroundColor(.white)
                        .font(.custom("Dosis-Bold", size: 20)),trailing: NavigationLink(destination: SearchPage()){Image(systemName: "magnifyingglass")}
